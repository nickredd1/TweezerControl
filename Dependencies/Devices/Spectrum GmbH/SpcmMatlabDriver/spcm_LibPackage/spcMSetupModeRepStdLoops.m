...
%**************************************************************************
% spcMSetupModeRepStdLoops:
% replay continuous mode
%**************************************************************************

function [success, cardInfo] = spcMSetupModeRepStdLoops (cardInfo, chEnableH, chEnableL, memSamples, loops)
    
    error = 0;
    
    % ----- setup the mode -----
    error = error + spcm_dwSetParam_i32 (cardInfo.hDrv, 9500,                  16384);  %  9500 = SPC_CARDMODE, 16384 = SPC_REP_STD_CONTINUOUS
